...
<html lang="en">
  ...
  <input type="submit" name="login" value="Login" class="form-control btn-color mt-4" id="exampleFormControlInput1"/>
  <div>
       
  <span>Belum Punya Akun? <a href="registrasi.php" class="text-login">Daftar</span>
</div>
</div>
</div>
